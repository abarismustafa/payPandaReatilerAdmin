        ...
        <>
            <aside className={`SidebarMain mCustomScrollbar _mCS_1 mCS-autoHide ${isActive ? 'hide-sidebar' : ''}`} id="aside" style={{}}>
              ...
              <div class="card-header">
                  <a href="https://m.masterpay.pro/Retailer/dmr2_home?crypt=5f1676e31c5d96aa5b20a66aa5476560aeb5bcd0ee05e7d7bc129066482ebf79ce298764a96059642b05824a81eb491139bf81aff9314add2ecd8c9cf2c5982c5kHici3~hSefddIo40RPNwxR8rxIeyqcKGeuQjFn~VU-">
                      <i>
                          <svg x="0" y="0" viewBox="0 0 17 17">
                              <path
                                  d="M9.444,17.000 L9.444,7.555 L17.000,7.555 L17.000,17.000 L9.444,17.000 ZM9.444,-0.000 L17.000,-0.000 L17.000,5.667 L9.444,5.667 L9.444,-0.000 ZM-0.000,11.333 L7.555,11.333 L7.555,17.000 L-0.000,17.000 L-0.000,11.333 ZM-0.000,-0.000 L7.555,-0.000 L7.555,9.444 L-0.000,9.444 L-0.000,-0.000 Z" />
                          </svg>
                      </i>
                    ...
                    <div className="card-header">
                        ...
                        <a href="https://m.masterpay.pro/Retailer/Axis_pos_device_booking?crypt=c1c1de9faceac19db8c7fcb30b86de4a4d08c2d84948367ea22c9b152cd6bc664fce4c05c54aa4ba86749f5d864e671f123108a95f413b9ef454784ee85db58b7SKDa8PZ6stxVbXkWK612cUz46hyb5Pf7r~f9rc3qa8-">
                            <i>
                                <svg viewBox="0 0 384 428.8">
                                    <path d="M302.6,214.2c0.1-61.9-50.1-112.2-112-112.3C128.6,101.9,78.3,152,78.3,214s50.1,112.2,112,112.3c33.2,0,64.7-14.6,86-40 C293.2,266,302.5,240.5,302.6,214.2z M380.3,38.8L336,0v14.4c0,4.4-3.6,8-8,8H56c-30.9,0-56,25.1-56,56v200h32v-184c0-22.1,17.9-40,40-40h256c4.4,0,8,3.6,8,8 v20.7L380.3,38.8z M384,150.4h-32v184c0,22.1-17.9,40-40,40H56c-4.4,0-8-3.6-8-8v-20.7L3.7,390L48,428.8v-14.4c0-4.4,3.6-8,8-8h272 c30.9,0,56-25.1,56-56V150.4z M234.9,158H200c6.1,4.9,10.6,11.8,11.8,21.6h23.1v10.6h-22.8c-2.1,21.6-19.3,35.3-46.3,36.2 c16.5,17.1,34.5,38.7,52.3,60.5h-20.3c-16.5-19.9-31.9-38.3-51.8-59.4v-13.1h11.6c22.8,0,35.1-9.5,36.6-24.1h-48.2v-10.6h47.6 c-3-12.3-14.2-18.4-32.6-18.4h-15v-13.8h89.1V158z" />
                                </svg>
                            </i>
                            <div style={{ flex: 2, position: 'relative', display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                <span>E-Pos</span>
                    ...
                    <div className="MenuItem ">
                        <div className="card-header collapsed" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                            <Link to="#" onClick={() => { setReport(!report) }}>
                                <i>
                        ...
                        <div id="collapseOne" className={`SubmenuItems collapse ${report ? "mm-show" : "extra"}`} >
                            <ul>
                                ...
                                {/*  <li >
                          <a href="https://m.masterpay.pro/Retailer/indonepal_report">Indo-Nepal Money Transfer - Old</a>
                      </li> */}
                                <li>
                                    <Link to="money_transfer_Reprot">Indo-Nepal Money Transfer</Link>
                                </li>
                                <li>
                                    <Link to="fastag_report">Fastag Report</Link>
                                </li>
                                <li>
                                    <Link to="dmt_report">DMT Report</Link>
                                </li>
                                <li>
                                    <Link to="dmt_report_search">DMT Report Search</Link>
                                </li>
                                <li>
                                    <Link to="dmtkyc_report">DMT-KYC Report</Link>
                                </li>
                                <li>
                                    <Link to="ccbill_payment_report">CC Bill Payment Report</Link>
                                </li>
                                <li>
                                    <Link to="Aeps_fino_report">AEPS (Xpress) Report</Link>
                                </li>
                                <li>
                                    <Link to="aeps_paytm_report">AEPS (Tez) Report</Link>
                                </li>
                                <li>
                                    <Link to="aeps_icici_report">AEPS (ICICI) Report</Link>
                                </li>
                                <li>
                                    <Link to="aadhaarpay_pay_report">Aadhaar Pay Report</Link>
                                </li>
                                <li>
                                    <Link to="insurancedekho_report">InsuranceDekho Report</Link>
                                </li>
                                <li>
                                    <Link to="bill_report">Bill Payment History</Link>
                                </li>
                                <li>
                                    <Link to="accountreport">Account Report</Link>
                                </li>
                                <li>
                                    <Link to="topuphistory">Balance Topup History</Link>
                                </li>
                                <li>
                                    <Link to="list_bank">Bank List</Link>
                                </li>
                                <li>
                                    <Link to="Aeps_payout_report">Aeps &amp; Epos Payout Report</Link>
                                </li>
                                {/* Insurance */}
                                {/* Insurance */}
                                {/* CMS Resport*/}
                                <li>
                                    <Link to="Cms_bill_report">CMS Bill Report</Link>
                                </li>
                                {/* CMS Resport*/}
                                {/* GiftCard */}
                                {/* GiftCard */}
                                {/* <li >
                          <a href="https://m.masterpay.pro/Retailer/Aeps_fino_report">AEPS (Xpress) Report</a>
                      </li>
                      <li >
                          <a href="https://m.masterpay.pro/Retailer/aeps_paytm_report">AEPS (Tez) Report</a>
                      </li>
                      <li >
                          <a href="https://m.masterpay.pro/Retailer/aeps_fingpay_report">AEPS (ICICI) Report</a>
                      </li>
                      <li >
                          <a href="https://m.masterpay.pro/Retailer/aadhaarpay_fingpay_report">Aadhaar Pay Report</a>
                                ...
                                {/* <li>
                                    <a href="#">EPOS Pending Transaction Report</a>
                                </li> */}
                                <li>
                                    <Link to="Turbo_payment_request">Turbo E-Loan Request</Link>
                                </li>
                                <li>
                                    <Link to="Pg_report_rz">Payment Gateway Report</Link>
                                </li>
                                <li>
                    ...
                    <div className="MenuItem ">
                        <div className="card-header collapsed" id="headingSettings" data-toggle="collapse" data-target="#collapseSettings" aria-expanded="false" aria-controls="collapseSettings">
                            <Link href="#" onClick={() => { setSetting(!setting) }}>
                                <i>
                        ...
                        <div id="collapseSettings" className={`SubmenuItems collapse ${setting ? "mm-show" : "extra"}`} aria-labelledby="headingSettings" data-parent="#accordion">
                            <ul>
                                ...
                                <li>
                                    <Link to="change_txnpassword">Create Tpin</Link>
                                </li>
                                <li>
