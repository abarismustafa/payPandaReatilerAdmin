                ...
                <div className="card mt-2" style={{ overflow: 'auto' }}>
                    <div className="card-body">
                        <div className="GridUi no-header-footer-grid" id="all_transaction">
                            ...
                            <div className="dataTables_length" id="myTable_length">
                            ...
                            </div><div id="tblcms_report_processing" className="dataTables_processing" style={{ display: 'none' }}>Processing...</div><table id="tblcms_report" className="table table-striped table-bordered table-hover display fixed_headers dataTable no-footer" style={{ width: 1854 }} role="grid" aria-describedby="tblcms_report_info">
                                <thead>
                                ...
                                <tbody>
                                    <tr className="odd"><td valign="top" colSpan={12} className="dataTables_empty">No data available in table</td></tr></tbody>
                            </table>
