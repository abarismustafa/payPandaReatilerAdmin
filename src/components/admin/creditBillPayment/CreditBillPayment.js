...
function CreditBillPayment() {
    return (
        <>
            <div className="PageHeading">
                <h1>Credit Card Bill Payment Report</h1>
            </div>
                        ...
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                ...
                                <div className="form-group col-md-2">
                                    ...
                                    <select id="ddldb" name="ddldb" className="form-control" fdprocessedid="3wusmv">
                                ...
                                <div className="form-group col-md-2">
                                    <label>&nbsp;</label>
                                    <input type="submit" name="btnSearch" id="btnSearch" defaultValue="Search" className="btn btn-primary" title="Click to search." fdprocessedid="ncrdck" />
                                </div>
                            </div>
                        </form></div>
