                        ...
                        <form action="" method="post" name="frmReport" id="frmReport">
                            ...
                            <div className="form-row" style={{ alignItems: 'end' }}>
                                <div className="form-group col-md-4">
                                    <label htmlFor="txtUserId">Account No./Sender No.</label>
                                    <input type="text" name="account_no" id="account_no" className="form-control" maxLength={30} />
                                </div>
                                ...
                                <div className="form-group col-md-2">
                                    <label>&nbsp;</label>
                                    <input type="submit" name="btnSearch" id="btnSearch" defaultValue="Search" className="btn btn-primary" title="Click to search." fdprocessedid="ro7rf" />
                                </div>
                                <div className="form-group col-md-2">
                                    <label>&nbsp;</label>
                ...
                <div className="card mt-4" style={{ overflow: 'auto' }}>
                    <div className="card-body">
                        <div id="myTable_wrapper" className="dataTables_wrapper no-footer">
                            ...
                            <div id="myTable_processing" className="dataTables_processing" style={{ display: 'none' }}>Processing...</div><table className="table table-striped table-bordered table-hover display dataTable no-footer dtr-inline collapsed" id="myTable" role="grid" aria-describedby="myTable_info" style={{ width: 1120 }}>
                            <thead>
