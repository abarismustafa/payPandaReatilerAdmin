                ...
                <div className="card mt-2" style={{ overflow: 'auto' }}>
                    <div className="card-body">
                        <div className="GridUi no-header-footer-grid" id="all_transaction">
                            ...
                            </div><div id="tblaeps_fingpay_report_processing" className="dataTables_processing" style={{ display: 'none' }}>Processing...</div><table id="tblaeps_fingpay_report" className="table table-striped table-bordered table-hover display fixed_headers dataTable no-footer" style={{ width: 1854 }} role="grid" aria-describedby="tblaeps_fingpay_report_info">
                                <thead>
