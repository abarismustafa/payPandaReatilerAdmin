                        ...
                        <div className="card-body">
                            ...
                            <div className="dataTables_length" id="myTable_length">
                                ...
                                <div className="form-group col-md-2">
                                    ...
                                    <div id="tbl_postpaid_transction_processing" className="dataTables_processing" style={{ display: 'none' }}>Processing...</div><table id="tbl_postpaid_transction" className="table table-striped table-bordered table-hover display fixed_headers dataTable no-footer" style={{ width: 1854 }} role="grid" aria-describedby="tbl_postpaid_transction_info">
                                    <thead>
